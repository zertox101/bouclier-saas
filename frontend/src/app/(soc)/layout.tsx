    ...
    return (
        ...
        >
            <div className="print:hidden">
                <LockdownSystem />
                <AnalystSidebar isCollapsed={isSidebarCollapsed} setIsCollapsed={setIsSidebarCollapsed} />
            </div>
            ...
            <div className={cn(
                ...
                >
                    <div className="flex items-center gap-6">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-amber-400 font-mono text-[11px]">
                                SOC://{session?.user?.id?.slice(0, 8) || "INIT"}
                            </span>
                        </div>
                    ...
                    <div className="flex items-center gap-6">
                        <span className="hover:text-slate-300 transition-colors cursor-default">Security Operations</span>
...
export default function SocLayout({ children }: { children: React.ReactNode }) {
    return (
        <NotificationProvider>
            <React.Suspense fallback={<div className="min-h-screen w-full bg-[#080C12] flex items-center justify-center font-mono text-slate-500 uppercase tracking-widest text-xs">Initializing SOC Terminal...</div>}>
