...
import {
  ...
  Target, Brain, Package, Bot, Database, Bug, Radio, Server
} from 'lucide-react';
...
const navSections = [
  {
    ...
    items: [
      ...
      { icon: Zap,             label: "Subscription & Plans", href: "/subscription",         badge: "SaaS" },
  ...
  },
  {
    ...
    items: [
      ...
      { icon: Radio,       label: "WireTapper OSINT",  href: "/wiretapper",   badge: "Live" },
      { icon: Terminal,    label: "Kali Arsenal",      href: "/arsenal" },
  ...
  },
  {
    ...
    items: [
      { icon: Globe,       label: "Gaia 3D (World Map)", href: "/threat-map-pro" },
      ...
      { icon: Brain,       label: "Sentinel AI",         href: "/sentinel",     badge: "AI" },
      { icon: Database,    label: "AI Reasoning Data",   href: "/ai-reasoning", badge: "Live" },
    ]
  },
  {
    ...
    items: [
      ...
      { icon: Package,     label: "Dossier & Slides",    href: "/reports" },
    ...
    >
      ...
      <div className={cn(
        ...
        <button
          ...
          className={cn(
            'ml-auto p-1.5 rounded-md text-slate-500 hover:text-white hover:bg-white/5 transition-all shrink-0',
            isCollapsed && 'hidden'
          )}
        >
      ...
      {/* ── User Footer ── */}
      <div className={cn('p-3 shrink-0', isCollapsed && 'flex justify-center')}>
        {isCollapsed ? (
          <button
            onClick={() => signOut()}
            title={userName}
